...
public class CommitsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView = (ListView) root.findViewById(R.id.lv_myproject_commit_list);
        ...
        MyProjectCommitsListTask mytask = (MyProjectCommitsListTask) new MyProjectCommitsListTask().execute("http://192.168.0.112:3001/api/user/detail");

        return root;
    }

    public class MyProjectCommitsListTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                JSONArray json_array = json.getJSONArray("commit_list");
                ...
                for(int i=0;i<json_array.length();i++){
                    ...
                    MyProjectCommitsDetailTask getProjDetail = (MyProjectCommitsDetailTask) new MyProjectCommitsDetailTask();
    ...
    public class MyProjectCommitsDetailTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                CommitsListDTO dto = new CommitsListDTO();
