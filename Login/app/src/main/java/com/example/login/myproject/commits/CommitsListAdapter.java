...
public class CommitsListAdapter extends BaseAdapter{
    ...
    private ArrayList<CommitsListDTO> listCustom = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.commits_list_item, null, false);

            holder = new CustomViewHolder();

            holder.textName = (TextView) convertView.findViewById(R.id.project_commit_list_title);
            holder.textAdmin = (TextView) convertView.findViewById(R.id.tv_commit_admin);
            holder.textInst = (TextView) convertView.findViewById(R.id.tv_commit_instruments);
            holder.textUpdate = (TextView) convertView.findViewById(R.id.tv_commit_recent);

            holder.play = (ImageButton) convertView.findViewById(R.id.myproject_commit_list_play);
            holder.stop = (ImageButton) convertView.findViewById(R.id.myproject_commit_list_pause);
            holder.seekBar = (SeekBar) convertView.findViewById(R.id.myproject_commit_list_seekBar);
            holder.show_time = (TextView) convertView.findViewById(R.id.show_commit_list_play_time);
        ...
        final CommitsListDTO dto = listCustom.get(position);
    ...
    public void addItem(CommitsListDTO dto) {

        listCustom.add(dto);
    }

    public void delItem(CommitsListDTO dto){
        listCustom.remove(dto);
    }

    public void modifyItem(int i, CommitsListDTO dto){
